...
if rta == 2:
    print("respuesta correcta")
    rtaC10 = 10
    print("Su puntaje:", rtaC10, "puntos")
else:
    print("respuesta incorrecta")
    rtaC10 = 0
print("----------decima primer pregunta----------")
...
if rta == 1:
    print("respuesta correcta")
    rtaC11 = 10
    print("Su puntaje:", rtaC11, "puntos")
else:
    print("respuesta incorrecta")
    rtaC11 = 0
print("----------decima segunda pregunta----------")
...
if rta == 2:
    print("respuesta correcta")
    rtaC12 = 10
    print("Su puntaje:", rtaC12, "puntos")
else:
    print("respuesta incorrecta")
    rtaC12 = 0
print("----------decima tercer pregunta----------")
...
if rta == 3:
    print("respuesta correcta")
    rtaC13 = 10
    print("Su puntaje:", rtaC13, "puntos")
else:
    print("respuesta incorrecta")
    rtaC13 = 0
print("----------decima cuarta pregunta----------")
...
if rta == 4:
    print("respuesta correcta")
    rtaC14 = 10
    print("Su puntaje:", rtaC14, "puntos")
else:
    print("respuesta incorrecta")
    rtaC14 = 0
print("----------decima quinta pregunta----------")
print("Cual selección es la que mas ha ganado la copa?")
seleccion1 = str("Italia")
seleccion2 = str("Francia")
...
if rta == 3:
    print("respuesta correcta")
    rtaC15 = 10
    print("Su puntaje:", rtaC15, "puntos")
else:
    print("respuesta incorrecta")
    rtaC15 = 0
print("----------decima sexta pregunta----------")
...
if rta == 1:
    print("respuesta correcta")
    rtaC16 = 10
    print("Su puntaje:", rtaC16, "puntos")
else:
    print("respuesta incorrecta")
    rtaC16 = 0
print("----------decima septima pregunta----------")
...
if rta == 3:
    print("respuesta correcta")
    rtaC17 = 10
    print("Su puntaje:", rtaC17, "puntos")
else:
    print("respuesta incorrecta")
    rtaC17 = 0
print("----------decima octava pregunta----------")
...
if rta == 1:
    print("respuesta correcta")
    rtaC18 = 10
    print("Su puntaje:", rtaC18, "puntos")
else:
    print("respuesta incorrecta")
    rtaC18 = 0
print("----------decima novena pregunta----------")
...
if rta == 2:
    print("respuesta correcta")
    rtaC19 = 10
    print("Su puntaje:", rtaC19, "puntos")
else:
    print("respuesta incorrecta")
    rtaC19 = 0
print("----------vigésima pregunta----------")
...
if rta == 3:
    print("respuesta correcta")
    rtaC20 = 10
    print("Su puntaje:", rtaC20, "puntos")
else:
    print("respuesta incorrecta")
    rtaC20 = 0
print("----------vigésima primer pregunta----------")
...
if rta == 1:
    print("respuesta correcta")
    rtaC21 = 10
    print("Su puntaje:", rtaC21, "puntos")
else:
    print("respuesta incorrecta")
    rtaC21 = 0
print("----------vigésima segunda pregunta----------")
...
if rta == 1:
    print("respuesta correcta")
    rtaC22 = 10
    print("Su puntaje:", rtaC22, "puntos")
else:
    print("respuesta incorrecta")
    rtaC22 = 0
rtaT = (rtaC1+rtaC2+rtaC3+rtaC4+rtaC5+rtaC6+rtaC7+rtaC8+rtaC9+rtaC10+rtaC11+rtaC12+rtaC13+rtaC14+rtaC15+rtaC16+rtaC17+rtaC18+rtaC19+rtaC20+rtaC21+rtaC22)
